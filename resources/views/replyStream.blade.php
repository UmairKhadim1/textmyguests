...
<html lang="en">
  <head>
    ...
    <meta property="og:title" content="{{ $shindig->name }} | Reply Stream on TextMyGuests" />
    <meta property="og:image" content="{{ env('APP_URL') }}/assets/images/live/TMG_og_image.jpg" />
    <meta property="og:description" content="Check out the live stream of pictures and messages from {{ $shindig->name }} on TextMyGuests" />
